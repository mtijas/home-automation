...
all_settings = {
    ...
    "hallway_light_default_brightness": (150, 255, 255, 180, 6),
    "hallway_light_turnoff_time": (3, 4, 3, 3, 1),
    "kitchen_light_default_kelvin": (6500, 5000, 4000, 3200, 2700),
    "kitchen_light_default_brightness": (255, 255, 255, 180, 65),
    ...
    "living_room_light_default_brightness": (200, 255, 200, 150, 100),
    "living_room_brightness_target": (19, 25, 19, 12, 6),
    "bedroom_light_default_kelvin": (6500, 5000, 4000, 3200, 2700),
    "bedroom_light_default_brightness": (255, 255, 200, 180, 100),
}
