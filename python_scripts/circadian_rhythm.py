...
all_settings = {
    ...
    "light_auto_awake_brightness_hallway": (150, 255, 200, 160, 65),
    # "light_auto_asleep_kelvin_hallway": (6500, 5000, 3800, 3200, 2700),
    # "light_auto_asleep_brightness_hallway": (150, 255, 200, 160, 65),
    "light_auto_away_kelvin_hallway": (6500, 5000, 3800, 3200, 2700),
    "light_auto_away_brightness_hallway": (150, 255, 200, 160, 65),
    "light_auto_awake_kelvin_kitchen": (6500, 5000, 3800, 3200, 2700),
    "light_auto_awake_brightness_kitchen": (255, 255, 200, 160, 90),
    # "light_auto_asleep_kelvin_kitchen": (6500, 5000, 3800, 3200, 2700),
    # "light_auto_asleep_brightness_kitchen": (255, 255, 200, 160, 90),
    # "light_auto_away_kelvin_kitchen": (6500, 5000, 3800, 3200, 2700),
    # "light_auto_away_brightness_kitchen": (255, 255, 200, 160, 90),
    "light_auto_awake_kelvin_toilet": (6500, 5000, 3800, 3200, 2700),
    "light_auto_awake_brightness_toilet": (255, 255, 200, 160, 65),
    # "light_auto_asleep_kelvin_toilet": (6500, 5000, 3800, 3200, 2700),
    # "light_auto_asleep_brightness_toilet": (255, 255, 200, 160, 65),
    # "light_auto_away_kelvin_toilet": (6500, 5000, 3800, 3200, 2700),
    # "light_auto_away_brightness_toilet": (255, 255, 200, 160, 65),
    "light_auto_awake_kelvin_living_room": (6500, 5000, 3800, 3200, 2700),
    "light_auto_default_brightness_living_room": (160, 205, 200, 110, 40),
    "light_auto_lightness_target_living_room": (65, 80, 60, 30, 15),
    "light_auto_awake_kelvin_bedroom": (6500, 5000, 3800, 3200, 2700),
    "light_auto_awake_brightness_bedroom": (255, 255, 200, 160, 80),
    # "light_auto_asleep_kelvin_bedroom": (6500, 5000, 3800, 3200, 2700),
    # "light_auto_asleep_brightness_bedroom": (255, 255, 200, 160, 80),
    # "light_auto_away_kelvin_bedroom": (6500, 5000, 3800, 3200, 2700),
    # "light_auto_away_brightness_bedroom": (255, 255, 200, 160, 80),
}
